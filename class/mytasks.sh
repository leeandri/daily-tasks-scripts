#!/bin/bash
#
# Script created by Lee Andriamaholison
# Description: This script creates and copies the data fie to the users' home directory.
# Date: 19-Mar-2024
# Version: 0.1
...
do
  ...
  then
    ...
    if [ -f /home/$i/data ];
    then
      echo "$TIMESTAMP [OK] The data file exist on $i's home directory" >> $LOG
    else
